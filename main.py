...
# Define respectivamente: velocidade, aceleração, velocidade de curva e aceleração de curva
...
DirCurva(90)
robo.stop()
# Aumenta a velocidade do robô para subir na rampa com mais precisão.
...
# Lista com cores possíveis para as plaquetas
